...
const Footer = () => {
  ...
  return <Box sx={{backgroundColor: "#c6f167", pt: 8}}>
    <CustomContainer>
      <CustomContainer>
        <Box sx={{py: 3}}>
          <Typography sx={{
        ...
        <Box sx={{py: 3}}>
          ...
          <IconBox>
            <Link to="#"><img src={fbIcon} alt="instagramIcon" style={{cursor: "pointer", width: "70%"}}/></Link>
            <Link to="#"><img src={twitterIcon} alt="vkIcon" style={{cursor: "pointer", width: "70%"}}/></Link>
            <Link to="#"><img src={linkedinIcon} alt="youtubeIcon" style={{cursor: "pointer", width: "70%"}}/></Link>
          </IconBox>
        </Box>
      </CustomContainer>
    </CustomContainer>
    <Box sx={{mt: 8, pl: 3, py: 3, pr: 3, textAlign: "center", display: "flex", justifyContent: "center", backgroundColor: "#151a1b"}}>
